                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="#" class="btn btn-small btn-primary">Complaints</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="text-center"><%= c.getStatus()%><input type="hidden" name="status" value="<%= c.getStatus()%>"></td>
                                        <td class="text-center"><textarea name="remarks" rows="0" cols="0"><%= c.getRemarks() %></textarea></td>
                                        <td>Edit</td>
                        ...
                        <div class="tm-table-mt tm-table-actions-row">
                            <div class="tm-table-actions-col-left">
                                <input type="submit" name="action" class="btn btn-danger" value="Close Complaint">
                            </div>
                            <div class="tm-table-actions-col-left">
                                <input type="submit" name="action" class="btn btn-danger" value="View closed Complaint">
                            </div>
