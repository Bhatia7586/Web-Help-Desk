                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="../ProductController" class="tm-edit-product-form" method="post">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" name="category">
                                        ...
                                        <%
                                        	...
                                        	{
                                        %>
                                        <option value="<%= pc.getId() %>"><%= pc.getProductCategory() %></option>
                                    	<%
                                        	}
                                    	%>
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    <label for="lot" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Product
                                        Lot
                                    </label>
                                    <input id="lot" name="lot" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                        <input type="submit" name="action" value="View Product" class="btn btn-primary">
                                    </div>
                                </div>
                            </form>
                        </div>
