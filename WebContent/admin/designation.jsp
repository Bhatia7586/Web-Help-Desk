        ...
        <div class="row tm-mt-big">
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">Add Designation</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="../EmployeeController" class="tm-edit-product-form" method="post">
                                <div class="input-group mb-3">
                                    <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Job
                                        Category
                                    </label>
                                    <input id="name" name="jobCategory" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
