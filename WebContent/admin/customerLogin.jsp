        ...
        <div class="row tm-mt-big">
            <div class="col-12 mx-auto tm-login-col">
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="../CustomerController" method="post" class="tm-login-form">
                                ...
                                <div class="input-group mt-3">
                                    <input type="submit" class="btn btn-primary d-inline-block mx-auto" name="action" value="Sign Up">
                                </div>
                                <div class="input-group mt-3">
