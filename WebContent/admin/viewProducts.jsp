...
List<ProductCategory> pclist = ProductDao.getProductCategory();
                    ...
                    <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="viewProducts.jsp">Products</a>
                                </li>
            ...
            <div class="row tm-content-row tm-mt-big">
                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="addProduct.jsp" class="btn btn-small btn-primary">Add New Product</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><%= p.getCategory().getProductCategory() %></td>
                                        <td class="text-center"><%= p.getDescription() %></td>
                ...
                <div class="col-xl-4 col-lg-12 tm-md-12 tm-sm-12 tm-col">
                    <div class="bg-white tm-block h-100">
                        ...
                        <a href="productCategory.jsp" class="btn btn-primary tm-table-mt">Add New Category</a>
                    </div>
                </div>
            </div>
