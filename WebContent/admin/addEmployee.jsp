...
List<Designation> dlist = EmployeeDao.getDesignation();
                ...
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="../EmployeeController" class="tm-edit-product-form" method="post">
                                <div class="input-group mb-3">
                                    <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Employee
                                        Name
                                    </label>
                                    <input id="name" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="category" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Designation</label>
                                    <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" name="designation">
                                ...
                                <div class="input-group mb-3">
                                    <label for="lot" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Email
                                    </label>
                                    <input id="lot" name="email" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="stock" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Password
                                    </label>
                                    <input id="stock" name="password" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
