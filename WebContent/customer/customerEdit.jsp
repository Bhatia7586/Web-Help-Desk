           	...
           	<div class="col_w420 float_l">
                <div id="contact_form">
                    ...
                    <form method="post" name="contact" action="../CustomerController">
						...
						<label for="firstname">First Name:</label> <input type="text" id="firstname" name="firstname" class="required input_field" value="<%= c2.getFirstname()%>"/>
						<div class="cleaner h10"></div>
						
						<label for="lastname">Last Name:</label> <input type="text" id="lastname" name="lastname" class="required input_field" value="<%= c2.getLastname()%>"/>
						<div class="cleaner h10"></div>

						<label for="email">Email:</label> <input type="text" class="validate-email required input_field" name="email" id="email" value="<%= c2.getEmail()%>"/>
						<div class="cleaner h10"></div>

						<label for="password">Password:</label> <input type="text" class="validate-subject required input_field" name="password" id="password" value="<%= c2.getPassword()%>"/>
						<div class="cleaner h10"></div>
						...
						Select if change required <input type="text" class="validate-subject required input_field" value="<%= c2.getGender()%>"/>
						<div class="cleaner h10"></div>
						
						<label for="phone">Phone:</label> <input type="text" class="validate-subject required input_field" name="phone" id="phone" value="<%= c2.getPhone()%>"/>
						<div class="cleaner h10"></div>               

						<input type="submit" value="Update" id="submit" name="action" class="submit_btn float_l" />
